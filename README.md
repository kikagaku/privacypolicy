...
（1）	当社は、本サービスに関連する業務のため、以下（ア）乃至（ウ）のとおりユーザーのユーザー情報を第三者に提供することがあり、ユーザーはあらかじめこれを承諾するものとします。

（ア）株式会社ベネッセiキャリアへの情報提供
- 提供先： 株式会社ベネッセiキャリア
