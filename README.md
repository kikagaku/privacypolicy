...
本ポリシーは、当社が当社のウェブサイト（ [https://www.kikagaku.ai](https://www.kikagaku.ai/) ）上で提供するAI・データサイエンス実践プログラムサービス」（以下「本サービス」といいます。）の利用に関し適用されます。また、当社が、本サービス上に掲載するプライバシーポリシーその他の個人情報保護方針又は利用規約等においてユーザー情報の取扱いについて規定する場合、当該規定も適用されるものとし、当該規定が本ポリシーと抵触する場合には、本ポリシーが優先されるものとします。
